...
export default function Footer() {
  return (
    <>
      <footer>
        <section className="pt-0 pb-10 bg-white sm:pt-16 lg:pt-24">
          <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-2 gap-x-4 xl:gap-x-12">
              <div className="hidden md:block col-span-2 md:col-span-4 xl:pr-8">
                <img
                  className="w-auto h-16 -m-8"
                  src="../assets/logo.png"
                  alt
                />
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center px-6 py-2 font-semibold text-primary transition-all duration-200 bg-accent2 rounded-md hover:bg-accent1 focus:bg-accent1 mt-7"
                >
                  <svg
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <p className="text-sm text-gray-600">
                © Copyright 2021, All Rights Reserved by Enable Upcycling
              </p>
